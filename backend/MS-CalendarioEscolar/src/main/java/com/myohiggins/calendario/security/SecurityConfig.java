package com.myohiggins.calendario.security;
...
// de usuario (Swagger y consola H2 quedan publicos). No recibe llamadas internas de otros MSes.
@Configuration
@EnableWebSecurity
public class SecurityConfig {
    ...
    @Value("${app.security.enabled:true}") //aca esta el interruptor :D
