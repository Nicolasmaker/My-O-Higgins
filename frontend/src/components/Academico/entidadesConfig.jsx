...
export const ENTIDADES = {
  curso: {
    ...
    campos: [
      ...
      { name: 'idNivel', label: 'ID nivel *', type: 'number', width: 6, rules: { required: 'Obligatorio' }, getValue: (i) => i.nivel?.idNiv ?? '', soloCrear: true },
      { name: 'idSala', label: 'ID sala *', type: 'number', width: 6, rules: { required: 'Obligatorio' }, getValue: (i) => i.sala?.idSal ?? '' },
    ],
